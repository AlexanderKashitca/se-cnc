...
TypeIIRMLPosition::~TypeIIRMLPosition(void)
{
    ...
    this->OldInputParameters                            =   nullptr ;
    this->CurrentInputParameters                        =   nullptr ;
    this->OutputParameters                              =   nullptr ;
    this->RMLVelocityObject                             =   nullptr ;
    this->ModifiedSelectionVector                       =   nullptr ;
    this->UsedStep1AProfiles                            =   nullptr ;
    this->StoredTargetPosition                          =   nullptr ;
    this->MinimumExecutionTimes                         =   nullptr ;
    this->BeginningsOfInoperativeTimeIntervals          =   nullptr ;
    this->EndingsOfInoperativeTimeIntervals             =   nullptr ;
    this->PhaseSynchronizationReferenceVector           =   nullptr ;
    this->PhaseSynchronizationCurrentPositionVector     =   nullptr ;
    this->PhaseSynchronizationTargetPositionVector      =   nullptr ;
    this->PhaseSynchronizationPositionDifferenceVector  =   nullptr ;
    this->PhaseSynchronizationCurrentVelocityVector     =   nullptr ;
    this->PhaseSynchronizationTargetVelocityVector      =   nullptr ;
    this->PhaseSynchronizationMaxVelocityVector         =   nullptr ;
    this->PhaseSynchronizationMaxAccelerationVector     =   nullptr ;
    this->PhaseSynchronizationTimeVector                =   nullptr ;
    this->PhaseSynchronizationCheckVector               =   nullptr ;
    this->ArrayOfSortedTimes                            =   nullptr ;
    this->ZeroVector                                    =   nullptr ;
    this->VelocityInputParameters                       =   nullptr ;
    this->VelocityOutputParameters                      =   nullptr ;
