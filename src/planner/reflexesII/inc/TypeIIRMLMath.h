...
//  ----------------------------------------------------------
#define OTG_INFINITY (static_cast<double>(1.0e100))
...
//  ----------------------------------------------------------
#define RML_INPUT_VALUE_EPSILON (static_cast<double>(1.0e-10))
...
//  ----------------------------------------------------------
#define RML_VALID_SOLUTION_EPSILON (static_cast<double>(1.0e-10))
...
//  ----------------------------------------------------------
#define RML_MAX_EXECUTION_TIME (static_cast<double>(1e10))
...
//  ----------------------------------------------------------
#define RML_ADDITIONAL_RELATIVE_POSITION_ERROR_IN_CASE_OF_EQUALITY (static_cast<double>(1e-7))
...
//! \sa TypeIIRMLPosition::CompareAndEventuallyAdaptInitialAndTargetStateofMotion()
//  ----------------------------------------------------------
#define RML_ADDITIONAL_ABSOLUTE_POSITION_ERROR_IN_CASE_OF_EQUALITY (static_cast<double>(1e-7))
...
//  ----------------------------------------------------------
#define POSITIVE_ZERO (static_cast<double>(1.0e-50))
...
//  ----------------------------------------------------------
#define ABSOLUTE_PHASE_SYNC_EPSILON (static_cast<double>(1.0e-6))
...
//! \sa TypeIIRMLVelocity::GetNextStateOfMotion()
//  ----------------------------------------------------------
#define RELATIVE_PHASE_SYNC_EPSILON (static_cast<double>(1.0e-3))
...
//! A value for infinity \f$ \infty = 10^{100} \f$
//  ----------------------------------------------------------
#define RML_INFINITY (static_cast<double>(1.0e100))
...
//  ----------------------------------------------------------
#define RML_POSITION_EXTREMS_TIME_EPSILON (static_cast<double>(1.0e-4))
...
//! \sa TypeIIRMLPosition::IsPhaseSynchronizationPossible()
//  ----------------------------------------------------------
#define PHASE_SYNC_COLLINEARITY_REL_EPSILON (static_cast<double>(1.0e-2))
