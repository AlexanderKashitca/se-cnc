...
*/
void CoordMotionClass::ReflexxesSetCurrentPosition(QVector<double> position)
{
    int axis;
...
///-----------------------------------------------------------------------------
void CoordMotionClass::ReflexxesSetCurrentVelocity(QVector<double> velocity)
{
    int axis;
...
///-----------------------------------------------------------------------------
void CoordMotionClass::ReflexxesSetCurrentAcceleration(QVector<double> acceleration)
{
    int axis;
...
///-----------------------------------------------------------------------------
void CoordMotionClass::ReflexxesSetTargetPosition(QVector<double> position)
{
    int axis;
    QVector<double>::iterator it_pos;
    axis = 0;
...
///-----------------------------------------------------------------------------
void CoordMotionClass::ReflexxesSetTargetVelocity(QVector<double> velocity)
{
    int axis;
    QVector<double>::iterator it_vel;
    axis = 0;
...
///-----------------------------------------------------------------------------
void CoordMotionClass::ReflexxesSetSelection(QVector<bool> enable)
{
    int axis;
...
///-----------------------------------------------------------------------------
bool CoordMotionClass::ReflexxesValidity()
{
                       ...
                       char XSTR, char YSTR, char ZSTR, QString &errmsg)
{
	...
	if (u_axis>=0)
	{
		if (u > MP->SoftLimitPosU) {errmsg="U+"; return 1;}
		if (u < MP->SoftLimitNegU) {errmsg="U-"; return 1;}
	}
	if (v_axis>=0)
	{
		if (v > MP->SoftLimitPosV) {errmsg="V+"; return 1;}
		if (v < MP->SoftLimitNegV) {errmsg="V-"; return 1;}
	}
	return 0;
}
///-----------------------------------------------------------------------------
