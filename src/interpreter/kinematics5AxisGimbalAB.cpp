///-----------------------------------------------------------------------------
/// Kinematics5AxisGimbalAB.cpp: implementation of the Kinematics5AxisGimbalABClass class.
///
...
#define sqr(x) ((x)*(x))
///-----------------------------------------------------------------------------
Kinematics5AxisGimbalABClass::Kinematics5AxisGimbalABClass()
{
...
int Kinematics5AxisGimbalABClass::RemapForNonStandardAxes(double *x, double *y, double *z, double *a, double *b, double *c)
{
	*c = *b;
	*b = 0.0;
...
void Kinematics5AxisGimbalABClass::Rotate3(double xc,double yc,double zc,double x,double y,double z,double a,double b,double c,
...
/// A axis rotates about X axis when B axis=0
/// B axis rotates about Z
int Kinematics5AxisGimbalABClass::TransformCADtoActuators(double x, double y, double z, double a, double b, double c, double *Acts, bool NoGeo)
{
...
///-----------------------------------------------------------------------------
int Kinematics5AxisGimbalABClass::InvertTransformCADtoActuators(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
	double Tol=1e-6;
...
int Kinematics5AxisGimbalABClass::TransformActuatorstoCAD(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
