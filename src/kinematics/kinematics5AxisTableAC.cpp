...
#if 0
///-----------------------------------------------------------------------------
/// Kinematics5AxisTableAC.cpp: implementation of the Kinematics5AxisTableACClass class.
///
...
#define sqr(x) ((x)*(x))
///-----------------------------------------------------------------------------
Kinematics5AxisTableACClass::Kinematics5AxisTableACClass()
{
...
void Kinematics5AxisTableACClass::Rotate3(double xc,double yc,double zc,double x,double y,double z,double a,double b,double c,
...
/// A axis rotates parallel to X
/// C axis rotates parallel to Z axis when A axis=0
int Kinematics5AxisTableACClass::TransformCADtoActuators(double x, double y, double z, double a, double b, double c, double *Acts, bool NoGeo)
{
...
///-----------------------------------------------------------------------------
int Kinematics5AxisTableACClass::InvertTransformCADtoActuators(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
	double Tol=1e-6;
...
int Kinematics5AxisTableACClass::TransformActuatorstoCAD(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
