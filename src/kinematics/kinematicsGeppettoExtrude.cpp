...
#if 0
///-----------------------------------------------------------------------------
/// KinematicsGeppettoExtrude.cpp: implementation of the KinematicsGeppettoExtrudeClass class.
///-----------------------------------------------------------------------------
#include "kinematicsGeppettoExtrude.h"
///-----------------------------------------------------------------------------
#define sqr(x) ((x)*(x))
///-----------------------------------------------------------------------------
KinematicsGeppettoExtrudeClass::KinematicsGeppettoExtrudeClass()
{
...
///-----------------------------------------------------------------------------
int KinematicsGeppettoExtrudeClass::TransformCADtoActuators(double x, double y, double z, double a, double b, double c, double *Acts, bool NoGeo)
{
...
///-----------------------------------------------------------------------------
int KinematicsGeppettoExtrudeClass::InvertTransformCADtoActuators(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
	double Tol=1e-6;
...
int KinematicsGeppettoExtrudeClass::TransformActuatorstoCAD(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
...
/// .
/// .
int KinematicsGeppettoExtrudeClass::ReadGeoTable(const char *name)
{
	double X, Y, Z, c;
	int row, col;
...
int KinematicsGeppettoExtrudeClass::GeoCorrect(double x, double y, double z, double a, double b, double c,
...
///-----------------------------------------------------------------------------
int KinematicsGeppettoExtrudeClass::GetSoftLimits(double *xm, double *xp, double *ym, double *yp, double *zm, double *zp,
