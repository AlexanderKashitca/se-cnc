...
#if 0
///-----------------------------------------------------------------------------
/// Kinematics5AxisTableAGimbalB.cpp: implementation of the Kinematics5AxisTableAGimbalBClass class.
///
...
#define sqr(x) ((x)*(x))
///-----------------------------------------------------------------------------
Kinematics5AxisTableAGimbalBClass::Kinematics5AxisTableAGimbalBClass()
{
...
void Kinematics5AxisTableAGimbalBClass::Rotate3(double xc,double yc,double zc,double x,double y,double z,double a,double b,double c,
...
/// A axis always rotates about X axis
/// B axis always rotates about Y axis
int Kinematics5AxisTableAGimbalBClass::TransformCADtoActuators(double x, double y, double z, double a, double b, double c, double *Acts, bool NoGeo)
{
...
///-----------------------------------------------------------------------------
int Kinematics5AxisTableAGimbalBClass::InvertTransformCADtoActuators(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
	double Tol=1e-6;
...
int Kinematics5AxisTableAGimbalBClass::TransformActuatorstoCAD(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
