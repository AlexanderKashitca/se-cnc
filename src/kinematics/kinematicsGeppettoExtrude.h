...
///-----------------------------------------------------------------------------
class KinematicsGeppettoExtrudeClass : public KinematicsClass
{
public:
	CPT3D Act0Center;
	CPT3D Act1Center;
	...
	double Act4Off;
	double Act5Off;
    KinematicsGeppettoExtrudeClass();
    virtual ~KinematicsGeppettoExtrudeClass();
...
///-----------------------------------------------------------------------------
#endif /// KINEMATICS_GEPPETTO_EXTRUDE_H
///-----------------------------------------------------------------------------
